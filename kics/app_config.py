"""
K-ICS QIS reporting dashboards application base configuration.
"""
...
from cm_dashboards.utilities import set_kics_name

# Define application name and title
PROJECT_NAME = "kics"
PROJECT_TITLE = "K-ICS QIS reporting dashboards"

# External scripts and CSS stylesheets
external_scripts = ["../static/utils/tabs.js", "../static/utils/merge_cells.js"]
