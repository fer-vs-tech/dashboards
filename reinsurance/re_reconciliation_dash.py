...
app = dash.Dash(
    name="re_reconciliation",
    server=server,
    url_base_pathname="/dash/re_reconciliation/",
...
app.layout = html.Div(
    children=[
        ...
        html.H2(children="Reinsurance Reconciliation", style={"color": "darkblue"}),
        html.Br(),
...
@app.callback(
    [
        Output("reconciliation", "columns"),
        Output("reconciliation", "data"),
        Output("reconciliation", "style_data_conditional"),
        Output("reconciliation", "hidden_columns"),
    ],
    [Input(component_id="jobrun", component_property="value")],
)
def reconciliation_callback(input_value):
    """
    ...
    style_cell_conditional = (
        ...
        + [
            ...
            },
            {
                ...
                "backgroundColor": "rgb(159, 189, 197)",
            },
        ]
    )
