...
from cm_dashboards.reinsurance import re_trial_balance_handler as tb
...
app = dash.Dash(
    name="re_trial_balance",
    server=server,
    url_base_pathname="/dash/re_trial_balance/",
...
app.layout = html.Div(
    children=[
        ...
        html.H2(children="Reinsurance Trial Balance", style={"color": "darkblue"}),
        html.Br(),
...
def trial_balance_callback(input_value):
    ...
    """
    handler = tb.ReTrialBalanceHandler()
